        ...
        <form action="{{ route("admin.users.update", [$user->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div style="margin:auto; dispplay:table; margin-bottom: 30px;">
                    @if($user->photo)
                        <img width="100" height="100" class="img-rounded mt-3" src="{{ url('storage/photoUsers/'.$user->photo ) }}">
                    @else
                        <img width="100" height="100" class="img-rounded mt-3" src="{{ url('storage/users/defaultsUsers.png' ) }}">
                    @endif
