                ...
                <div class="row mb-2">
                    <div class="col-sm-6 offset-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ trans('projet.projet.Creer')  }} {{ trans('projet.projet.projet')  }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">{{ trans('projet.projet.Creer')  }} {{ trans('projet.projet.projet')  }}</h3>
                            </div>
                            <!-- /.card-header -->

                            <!-- form start -->
                            <form role="form" action="{{ route('admin.projet.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary float-md-right">{{ trans('projet.projet.save')  }} {{ trans('projet.projet.projet')  }}</button>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
